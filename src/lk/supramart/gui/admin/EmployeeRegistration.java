...
public class EmployeeRegistration extends javax.swing.JDialog {
    ...
    private static EmployeeRegistration employeeRegistration;
    ...
    public static synchronized EmployeeRegistration getInstance(JFrame frame){
        if(employeeRegistration == null){
            employeeRegistration = new EmployeeRegistration(frame, true);
        }
        return employeeRegistration;
    }
    private EmployeeRegistration(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        if (is != null) {
            try {
                img = ImageIO.read(is);
                circularImagePanel.setImage(img);
    ...
    private void register() {
        ...
        Employee.Builder employee = new Employee.Builder(idField.getText().trim())
    ...
    private void initComponents() {
        ...
        circularImagePanel = new lk.supramart.component.CircularImagePanel();
        ...
        circularImagePanel.setBackground(new java.awt.Color(255, 255, 255));

        javax.swing.GroupLayout circularImagePanelLayout = new javax.swing.GroupLayout(circularImagePanel);
        circularImagePanel.setLayout(circularImagePanelLayout);
        circularImagePanelLayout.setHorizontalGroup(
            circularImagePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 0, Short.MAX_VALUE)
        );
        circularImagePanelLayout.setVerticalGroup(
            circularImagePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(circularImagePanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(circularImagePanel, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        statusMessage.setForeground(new java.awt.Color(102, 204, 0));
        statusMessage.setText("error / success Message");
    ...
    private lk.supramart.component.CircularImagePanel circularImagePanel;
